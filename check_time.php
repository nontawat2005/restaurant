...
<body>
    ...
    <div class="info-card">
        ...
        <a href="queue.php" style="display: block; margin-top: 20px; margin-bottom: 15px; padding: 12px; background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: bold; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            📝 ลงชื่อจองคิวรอโต๊ะ
        </a>
    </div>
